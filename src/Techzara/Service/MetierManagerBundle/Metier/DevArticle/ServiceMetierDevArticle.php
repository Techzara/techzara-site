...
namespace App\Techzara\Service\MetierManagerBundle\Metier\DevArticle;
...
class ServiceMetierDevArticle
{
     ...
     * @return boolean
     */
    public function deleteDevArticle($article)
    {
     ...
     * @return boolean
     */
    public function deleteDevArticleGroup($_ids)
    {
