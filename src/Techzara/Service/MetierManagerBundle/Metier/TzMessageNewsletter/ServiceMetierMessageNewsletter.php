...
namespace App\Techzara\Service\MetierManagerBundle\Metier\TzMessageNewsletter;
...
class ServiceMetierMessageNewsletter
{
    ...
    {
        return $this->_entity_manager->getRepository(EntityName::TZ_MESSAGE_NEWSLETTER);
    }
     ...
     * @param TzMessageNewsletter $_message_newsletter
    ...
    public function insertFrontMessageNewsletter($_message)
    {
        ...
        $_message_newsletter = new TzMessageNewsletter();
    ...
    public function sendEmailNewsletter($_request, $_emails)
    {
        ...
        $_template = 'AdminBundle:TzMessageNewsletter:email.html.twig';
