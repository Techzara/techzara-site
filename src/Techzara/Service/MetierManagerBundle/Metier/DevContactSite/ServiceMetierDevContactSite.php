...
namespace App\Techzara\Service\MetierManagerBundle\Metier\DevContactSite;
...
class ServiceMetierDevContactSite
{
    ...
    public function sendEmail($_data, $_file_join)
    {
        ...
        $_template   = 'FrontSiteBundle:DevContact:email.html.twig';
        ...
        $_email_body = implode("\n", array_slice(explode("\n", $_email_body), 4));
        $_message    = (new \Swift_Message('Contact sur le site Techzara.fr'))
