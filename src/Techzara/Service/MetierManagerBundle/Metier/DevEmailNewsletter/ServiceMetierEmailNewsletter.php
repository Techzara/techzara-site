...
namespace App\Techzara\Service\MetierManagerBundle\Metier\DevEmailNewsletter;
...
class ServiceMetierEmailNewsletter
{
    ...
    {
        return $this->_entity_manager->getRepository(EntityName::LV_EMAIL_NEWSLETTER);
    }
     ...
     * @param DevEmailNewsletter $_email_newsletter
    ...
    public function insertFrontEmailNewsLetter($_email)
    {
        ...
        $_email_newsletter = new DevEmailNewsletter();
     ...
     * @return array
     */
    public function unsubscriberById(DevEmailNewsletter $_email_newsletter)
    {
