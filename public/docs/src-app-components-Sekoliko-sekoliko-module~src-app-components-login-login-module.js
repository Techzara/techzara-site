(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["src-app-components-Sekoliko-sekoliko-module~src-app-components-login-login-module"],{
 ...
 */
var /** @type {?} */ VERSION = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["Version"]('6.0.0-beta.16');
...
var FlexLayoutModule = /** @class */ (function () {
    ...
    function (configOptions, breakpoints) {
        var /** @type {?} */ config = Object.assign({}, _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_2__["DEFAULT_CONFIG"]);
        ...
        if (configOptions.serverLoaded) {
            moduleProviders.push({ provide: _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_2__["SERVER_TOKEN"], useValue: true });
        }
        if (Array.isArray(breakpoints)) {
            moduleProviders.push({ provide: _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_2__["BREAKPOINT"], useValue: breakpoints, multi: true });
        }
        moduleProviders.push({ provide: _angular_flex_layout_core__WEBPACK_IMPORTED_MODULE_2__["LAYOUT_CONFIG"], useValue: config });
        return {
...
//# sourceMappingURL=src-app-components-Sekoliko-sekoliko-module~src-app-components-login-login-module.js.map