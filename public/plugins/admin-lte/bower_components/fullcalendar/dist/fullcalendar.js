...
var MouseFollower = Class.extend(ListenerMixin, {
	...
	// Causes the element to stop following the mouse. If shouldRevert is true, will animate backoffice to original position.
...
Grid.mixin({
	...
	// Queries for caller-specified color, then falls backoffice to default
...
var DayTableMixin = FC.DayTableMixin = {
	...
	renderHeadIntroHtml: function() {
		return this.renderIntroHtml(); // fall backoffice to generic
	},
...
var TimeGrid = FC.TimeGrid = Grid.extend(DayTableMixin, {
	...
	computeLabelInterval: function(slotDuration) {
		...
		return moment.duration(slotDuration); // fall backoffice. clone
	},
	...
	initMomentInternals: function() {
		...
		this.optionsModel.watch('buildingMomentLocale', [
			...
			var localeData = createObject( // make a cheap copy
				getMomentLocaleData(opts.locale) // will fall backoffice to en
			);
...
Calendar.mixin({
	...
	buildViewSpec: function(requestedViewType) {
		...
		// fall backoffice to top-level `duration` option
	...
	buildViewSpecButtonText: function(spec, requestedViewType) {
		...
		// requested view, falling backoffice to a generic unit entry like "week" or "day"
		...
		spec.buttonTextDefault =
			...
			requestedViewType; // fall backoffice to given view name
	}
...
FC.locale = function(localeCode, newFcOptions) {
	...
	momOptions = getMomentLocaleData(localeCode); // will fall backoffice to en
...
var AgendaView = FC.AgendaView = View.extend({
	...
	setHeight: function(totalHeight, isAuto) {
		...
		// reset all dimensions backoffice to the original state
